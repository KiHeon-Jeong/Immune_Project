...
## 1) 개요
본 폴더는 요양원 거주 민감계층 대상 프로젝트의 면역/감염 리스크 분석 파트입니다.
프로젝트 수행계획서(`(KDT_오라클)_2조_프로젝트_수행계획서_2026.02.26.docx`)의 방향에 맞춰,
...
## 7) 참고
- 본 README는 폴더 내 파일명/노트북 로그/수행계획서 내용을 기준으로 정리한 문서입니다.
- 코드 및 쿼리 원문은 수정하지 않았습니다.
